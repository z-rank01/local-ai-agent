...
| UI Phase 2：外观设置 MVP | ✅ 已实现 | 右侧面板新增“外观”设置；支持正文字体、代码字体、自定义字体栈、正文/代码字号、阅读宽度和界面密度，并持久化到浏览器 localStorage。 |
...
> 2026-04-26 UI 外观设置补充：当前 Web UI 已完成 Phase 2 外观设置 MVP，入口位于右侧面板“外观”；设置会即时更新 CSS variables，并保存到浏览器 localStorage。浏览器无法可靠读取系统完整字体列表，因此当前采用常用预设 + 自定义字体栈输入的方式支持本机已安装字体。
